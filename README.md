# 项目简介
本项目是北京邮电大学（BUPT）智能工程与自动化学院智能机器人与具身智能控制系统实验室（Intelligent Robot and Embodied AI System Lab，简称 IRES Lab） 官方网站的源代码仓库。网站基于 Bootstrap 框架开发，采用「Office BOOTSTRAP TEMPLATE」模板构建，具备响应式布局、多页面架构、高可定制性等核心优势，设计风格简洁美观、轻量化，可全方位展示实验室的研究方向、团队构成、招生信息及最新动态，同时适配成果展示（Portfolio）、机构介绍（Corporate）、创新内容传播（Creative）等多场景使用需求。
